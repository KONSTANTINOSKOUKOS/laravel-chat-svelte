import { w as writable, c as create_ssr_component, s as subscribe, e as escape, a as add_attribute, v as validate_component, b as set_store_value, d as each } from "../ssr.js";
...
const Chat = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  set_store_value(msgs, $msgs = newMsg ? [...$msgs, newMsg] : messages, $msgs);
